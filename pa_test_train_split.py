...
# python pa_test_train_split.py --base_path /data3/physionet.org/pa_filter/pa_filtered_images --csv_file /data3/physionet.org/files/mimic-cxr-jpg/2.1.0/files/mimic-cxr-2.0.0-split.csv --output_path ./data
